...
<div class="evolution-slider-container">
  <div class="evolution-slider">
    ...
    <div class="evolution-slide"><img src="https://github.com/vrrp/sachabook_modulo1/blob/main/docs/images/preambulo/rev1.png?raw=true" alt="Imagen 1"></div>
    ...
    <div class="evolution-slide"><img src="https://github.com/vrrp/sachabook_modulo1/blob/main/docs/images/preambulo/rev3.png?raw=true" alt="Imagen 3"></div>
...
.evolution-prev { left: 15px; }
.evolution-next { right: 15px; }
.evolution-prev:hover, .evolution-next:hover { 
...
<script>
(function() {
  let evolutionSlideIndex = 0;
  const evolutionSlides = document.querySelectorAll('.evolution-slide');
  
  window.evolutionMoveSlide = function(n) {
    evolutionSlideIndex += n;
    if (evolutionSlideIndex >= evolutionSlides.length) evolutionSlideIndex = 0;
    if (evolutionSlideIndex < 0) evolutionSlideIndex = evolutionSlides.length - 1;
    document.querySelector('.evolution-slider').style.transform = `translateX(-${evolutionSlideIndex * 100}%)`;
  };
})();
</script>
